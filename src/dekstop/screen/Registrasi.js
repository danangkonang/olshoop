   ...
   return(
      <div className="wrapper-registrasi">
         <div className="card-registrasi">
            <div className="sub-card-registrasi">
               a
            </div>
            <div className="sub-card-registrasi">
               <div className="card-registrasi-form">
                  <div className="title-registrasi">registrasi</div>

                  <div>
                     <div className="form-input-registrasi">
                        <label>Email
                           <input type="text" className="input-text-registrasi"/>
                        </label>
                     </div>
                     <div className="form-input-registrasi">
                        <label>Password
                     ...
                     <button className="btn-registrasi-form">registrasi</button>
